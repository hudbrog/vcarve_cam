...
Date: 2026-09-11\
Status: implementation design; GUI1 egui evaluation continues under the revised accessibility scope; no GUI milestone is technically complete.\
...
AccessKit gap remains an accepted limitation. Keyboard navigation, focus, IME,
named controls for framework tests and the remaining GUI1 probes still apply;
