...
Date: 2026-09-11\
Status: implementation design; GUI1 is complete and its framework decision is accepted with explicit scope limits (Windows x86_64 native and desktop Chromium/WebGPU). GUI2a is the next slice and has not started.\
...
GUI2 production work has not started.
