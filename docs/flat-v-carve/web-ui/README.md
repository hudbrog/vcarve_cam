...
Date: 2026-09-05\
Status: product design baseline; U1/U2, bounded U3 planning/2D inspection, U5 M5/M6 integration, the local tool library, and U9 in-browser-engine static hosting are implemented.\
