...
M0–M3 implement geometry, cutter/target models, SVG import, portable jobs, endmill clearing, whole-segment clearance checks, and stock previews from recorded cutting moves. V-bit finishing, full-volume verification, and LinuxCNC output follow in later milestones.
