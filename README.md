...
The [2.5D CAM architecture and implementation handoff](docs/flat-v-carve/2.5d-cam-plan.md) plans the operation list, physical stock/origins, facing, profiling with tabs/finishing/leads, passive drag-knife cutting, and a simulation-centered workflow. It includes proposed data contracts, migration rules, planner algorithms, implementation slices, and acceptance fixtures; these additions are not yet implemented.
